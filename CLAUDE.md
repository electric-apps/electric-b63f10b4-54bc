...
## Git & GitHub (CRITICAL)
Git is already initialized and the remote is configured to push to `electric-apps/electric-b63f10b4-54bc`.
The GitHub repo has been created at: https://github.com/electric-apps/electric-b63f10b4-54bc
...
```bash
git add -A
git commit -m "chore: scaffold electric-b63f10b4-54bc"
...
- Do NOT push to any repository other than `electric-apps/electric-b63f10b4-54bc`
